            ...
            <div className="container mx-auto px-4">
                <FadeIn>
                    <div className="flex flex-col md:flex-row justify-between items-end mb-10">
                        <div>
                            <span className="text-secondary dark:text-secondary font-bold tracking-widest text-sm uppercase mb-2 block">
                                Latest Insights
                            </span>
                        ...
                        <Link href="/blog" className="hidden md:flex items-center gap-2 text-secondary hover:text-secondary font-bold transition-colors group">
                ...
                <div className="mt-8 text-center md:hidden">
                    <Link href="/blog" className="inline-flex items-center gap-2 text-secondary hover:text-secondary font-bold transition-colors group">
                        View All Articles <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
                    </Link>
                </div>
            </div>
