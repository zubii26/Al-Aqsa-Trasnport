    ...
    return (
        <section className="py-20 bg-slate-50 dark:bg-slate-900 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-secondary/5 rounded-full blur-3xl -mr-32 -mt-32" />
            ...
            <div className="container mx-auto px-4 relative z-10">
                <FadeIn animate={true}>
                    <div className="text-center mb-16">
                        <span className="text-secondary dark:text-secondary font-bold tracking-widest uppercase text-sm mb-3 block">
                            Pilgrim Reviews
                        </span>
                        <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6">
                            What Our <span className="text-secondary dark:text-secondary">Pilgrims Say</span>
                        </h2>
                ...
                >
                    {curatedTestimonials.map((testimonial) => (
                        ...
                        >
                                <Quote className="absolute top-6 right-6 text-secondary/10 group-hover:text-secondary/20 transition-colors" size={48} strokeWidth={1} />
                                ...
                                <div className="flex items-center gap-4 mt-auto pt-6 border-t border-slate-100 dark:border-slate-700">
                                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-amber-100 to-amber-200 dark:from-amber-900 dark:to-amber-800 flex items-center justify-center text-secondary dark:text-amber-300 font-bold text-lg shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-slate-500 dark:text-slate-400 flex items-center gap-1">
                                            <span className="font-medium text-secondary dark:text-secondary">{testimonial.origin}</span>
