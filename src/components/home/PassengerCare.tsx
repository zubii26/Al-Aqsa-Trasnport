        ...
        <section className="py-16 md:py-24 bg-white dark:bg-slate-950">
            <div className="container mx-auto px-4">
                ...
                <div className="space-y-16 md:space-y-24">
                    ...
                    <motion.div 
                        className="care-panel flex flex-col md:flex-row items-center gap-8 md:gap-20 relative overflow-hidden rounded-3xl"
                        initial="hidden"
                        whileInView="visible"
                    ...
                    >
                        <div className="w-full md:w-1/2 relative">
                            ...
                            <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
                                ...
                                />
                                <Image
                                    src="/images/blog/solo-sister-travel.webp"
                    ...
                    {/* Families */}
                    <motion.div 
                        className="care-panel flex flex-col md:flex-row-reverse items-center gap-8 md:gap-20 relative overflow-hidden rounded-3xl"
                        initial="hidden"
                        whileInView="visible"
                        viewport={{ once: true, amount: 0.2 }}
                        variants={{
                    ...
                    >
                        <div className="w-full md:w-1/2 relative">
                            ...
                            <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
                                ...
                                />
                                <Image
                                    src="/images/blog/family-umrah-transport.webp"
                    ...
                    >
                        <div className="w-full md:w-1/2 relative">
                            ...
                            <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
                                ...
                                />
                                <Image
                                    src="/images/blog/elderly-care-gmc.webp"
