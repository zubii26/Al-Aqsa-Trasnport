                    ...
                    <div className="relative z-10 grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 p-6 md:p-12 lg:p-16 items-center">
                        ...
                        <div className="order-2 lg:order-1 flex flex-col justify-center">
                            ...
                            <div className="inline-flex items-start md:items-center gap-3 px-4 py-3 rounded-2xl bg-red-500/10 backdrop-blur-md border border-red-500/20 text-red-100 text-sm md:text-base font-medium mb-8 max-w-xl group hover:bg-red-500/15 transition-colors cursor-default">
                                <AlertTriangle className="shrink-0 text-red-500 animate-pulse" size={20} strokeWidth={1.5} />
                            ...
                            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">
                                ...
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#F3E5AB] drop-shadow-sm">Promise</span>
                            </h2>
                            ...
                            <motion.div 
                                className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 trust-grid"
                                initial="hidden"
                                whileInView="visible"
                            ...
                            >
                                ...
                                {/* Feature Card 2 */}
                                <motion.div 
                                    className="card-base trust-card group flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-green-500/30 transition-all duration-300"
                                    variants={{
                                        hidden: { opacity: 0, y: 40, rotateX: 12 },
                                        visible: { opacity: 1, y: 0, rotateX: 0, transition: { duration: 0.9, ease: [0.16, 1, 0.3, 1] } }
                                    }}
                        ...
                        <div className="order-1 lg:order-2">
                            <div className="relative rounded-[28px] p-[1px] bg-gradient-to-b from-slate-700/50 to-slate-800/20 shadow-2xl overflow-hidden">
                                <div className="bg-slate-900/60 backdrop-blur-3xl rounded-[28px] p-6 md:p-8 relative h-full">
                                    ...
                                    <h4 className="text-white font-semibold tracking-tight text-xl md:text-2xl mb-6">Standard Operating Procedure</h4>
                                    ...
                                    <div className="mt-8 pt-6 border-t border-slate-700/50 text-center">
                                        <a href="/safety" className="text-xs md:text-sm text-slate-400 hover:text-white transition-colors flex items-center justify-center gap-2 group">
                                            ...
                                            <Zap size={14} className="text-[#D4AF37] group-hover:fill-[#D4AF37] transition-all" strokeWidth={1.5} />
                                        </a>
                                    </div>
                                </div>
                            </div>
