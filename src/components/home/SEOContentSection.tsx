                ...
                <FadeIn>
                    <div className="max-w-4xl mx-auto space-y-10">
                        ...
                        <div className="prose dark:prose-invert max-w-none text-center md:text-left space-y-6">
                            ...
                            <p className="text-lg text-muted-foreground leading-relaxed">
                                Our comprehensive services include seamless <strong><Link href="/umrah/services/jeddah-airport-transfer" className="text-primary hover:underline">Jeddah Airport transfers</Link></strong>, <strong><Link href="/umrah/services/madinah-airport-transfer" className="text-primary hover:underline">Madinah Airport pickups</Link></strong>, and reliable <strong><Link href="/umrah/services/makkah-madinah-taxi" className="text-primary hover:underline">Makkah to Madinah taxi</Link></strong> services. We specialize in intercity pilgrim travel, offering door-to-door convenience from your hotel in Makkah to your accommodation in Madinah, or directly to the Haram.
                            </p>
                            <p className="text-lg text-muted-foreground leading-relaxed">
                                Travel in style with our <strong>VIP fleet</strong> comprising modern <strong><Link href="/umrah/fleet/gmc-yukon-at4" className="text-primary hover:underline">GMC Yukons</Link></strong>, <strong><Link href="/umrah/fleet/hyundai-staria" className="text-primary hover:underline">luxury vans</Link></strong> (H1/Staria), and business-class vehicles tailored for families, ladies, and groups. Our chauffeur-driven services guarantee a stress-free experience, allowing you to focus entirely on your worship. Book your <strong><Link href="/umrah/services/makkah-madinah-taxi" className="text-primary hover:underline">Haram shuttle</Link></strong> or airport transfer today and experience the difference of traveling with a company that values your peace of mind above all.
                            </p>
                        </div>
