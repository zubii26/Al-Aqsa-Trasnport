        ...
        <AnimatedSection className="py-24 relative overflow-hidden">
            ...
            <div className="container">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <GlassCard delay={0.1} className="text-center group hover:bg-white/5 border-white/10 dark:border-white/5">
                    ...
                    <GlassCard delay={0.2} className="text-center group hover:bg-white/5 border-white/10 dark:border-white/5">
                        <div className="mb-6 inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/5 text-secondary group-hover:scale-110 group-hover:bg-secondary/10 transition-all duration-300 shadow-lg shadow-secondary/5">
                            <Clock size={32} />
                        </div>
                    ...
                    <GlassCard delay={0.3} className="text-center group hover:bg-white/5 border-white/10 dark:border-white/5">
                        <div className="mb-6 inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/5 text-secondary group-hover:scale-110 group-hover:bg-secondary/10 transition-all duration-300 shadow-lg shadow-secondary/5">
                            <Heart size={32} />
                        </div>
